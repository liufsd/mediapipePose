 ...
 * @date 2022/6/14
 */
public class CustomFrameProcessor implements TextureFrameProcessor, AudioDataProcessor {
     ...
     * @param graphName the name of the file containing the binary representation of the graph.
     */
    public CustomFrameProcessor(Context context, String graphName) {
        initializeGraphAndPacketCreator(context, graphName);
    }
     ...
     */
    public CustomFrameProcessor(CalculatorGraphConfig graphConfig) {
    ...
    public void addPacketCallbacks(String outputStream, PacketListCallback callback) {
        List<String> strings = new ArrayList<>();
        strings.add(outputStream);
        mediapipeGraph.addMultiStreamCallback(strings, callback);
    }
